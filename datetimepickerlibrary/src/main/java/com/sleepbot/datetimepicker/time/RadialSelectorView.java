...
public class RadialSelectorView extends View {
    ...
    public ObjectAnimator getDisappearAnimator() {
        ...
        disappearAnimator.addUpdateListener((AnimatorUpdateListener) mInvalidateUpdateListener);
    ...
    public ObjectAnimator getReappearAnimator() {
        ...
        reappearAnimator.addUpdateListener((AnimatorUpdateListener) mInvalidateUpdateListener);
